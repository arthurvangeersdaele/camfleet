...
// identifiers
const char *ssids[] = {"Metrologie", "PC Arthur", "iPhone 13 Arthur"};
const char *passwords[] = {"8491metrologie", "0491226694", "0491226694"};
const int numNetworks = sizeof(ssids) / sizeof(ssids[0]);

const char *host = "script.google.com";
String myDeploymentID = "AKfycbxcL2gO7I2o2ZjObQcbqOsHcNffnBtBcru9HYGsJbx_El2G1bzN97gaNGZjcQtgf9I6Qw";  // upload only
